...
void TTFGame() {
    ...
    SDL_Surface* loadedSurface = IMG_Load("C:/Users/ASUS/Desktop/sdlproject/Practice/Practice/x64/Debug/test2.png"); // 여기 이미지파일은 아직.. 경로도 이상하고.. 미치겠다
    ...
    bool running = true;
    SDL_Event e;
    SDL_Rect img1Rect = { 460, 390, 300, 300 };  // 왼쪽 이미지
    SDL_Rect img2Rect = { 1160, 390, 300, 300 }; // 오른쪽 이미지
